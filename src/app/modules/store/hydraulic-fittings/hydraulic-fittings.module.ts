...
import {HydraulicFittingsRoutingModule, AppRoutedComponents} from "./hydraulic-fittings-routing.module";
...
@NgModule({
  ...
  imports: [
    CommonModule,
    FormsModule,
    HydraulicFittingsRoutingModule,
    MehrGridModule,
    MehrButtonModule,
    MehrInputModule,
    MehrCheckBoxModule,
...
export class HydraulicFittingsModule {
}
